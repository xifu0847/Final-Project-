...
if __name__ == '__main__':
	...
	sns.heatmap(matrix_neg, vmin=-1, vmax=0, cmap='coolwarm', xticklabels=xticks, yticklabels=yticks)
	...
	sns.heatmap(matrix_neg, vmin=0, vmax=1, cmap='coolwarm', xticklabels=xticks, yticklabels=yticks)
